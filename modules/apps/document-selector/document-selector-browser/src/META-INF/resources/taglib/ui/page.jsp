...
SearchContainer itemSearchContainer = (SearchContainer)request.getAttribute("document-selector:view-entries:itemSearchContainer");
String tabName = GetterUtil.getString(request.getAttribute("document-selector:view-entries:tabName"));
%>

<liferay-util:html-top outputKey="document-selector-browse-taglib">
	<link href="/o/document-selector-browser/css/browser.css" rel="stylesheet" type="text/css" />
</liferay-util:html-top>

<div class="item-browser-container style-<%= displayStyle %>" id="<%= idPrefix %>ImageSelectorContainer">
