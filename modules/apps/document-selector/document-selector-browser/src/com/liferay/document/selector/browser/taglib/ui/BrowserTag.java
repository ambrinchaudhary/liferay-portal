...
package com.liferay.document.selector.browser.taglib.ui;

import com.liferay.document.selector.browser.ServletContextProvider;
...
public class BrowserTag extends IncludeTag {
	...
	protected void setAttributes(HttpServletRequest request) {
		...
		request.setAttribute(
			"document-selector:view-entries:itemSearchContainer",
